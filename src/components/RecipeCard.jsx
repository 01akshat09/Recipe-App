...
const RecipeCard = ({ recipe, bg, badge }) => {
  ...
  return (
    <div
      className={`flex flex-col ${bg} rounded-md overflow-hidden p-3 relative`}
    >
      <a
      ...
      >
        ...
        <img
          src={recipe.image}
          alt="recipe image"
          className="rounded-md h-full w-full object-cover cursor-pointer opacity-0 transition-opacity duration-500"
          onLoad={(e) => {
